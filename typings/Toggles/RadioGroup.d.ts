...
declare const restrictedKeys: readonly [
  'checked',
  'handleChange',
  'name',
  'required',
...
export type TRadioProps<R extends Radio> = {
  ...
  : {});
export declare function RadioGroup<R extends Radio>({
  checked,
  className,
  disabled,
  handleChange,
  ...
  required,
  requiredText,
}: IRadioGroupProps<R>): import('react/jsx-runtime').JSX.Element;
export declare function Radio<R extends Radio>({
  checked,
  className,
  handleChange,
  id,
  ...
  required,
  value,
}: TRadioProps<R>): import('react/jsx-runtime').JSX.Element;
export {};
